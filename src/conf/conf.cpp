...
struct option Conf::long_options[] = {
        ...
        MAKE_LONG_OPT_ENTRY(PERS_SERVER_CLOCK_SKEW_DELTA_US),
        MAKE_LONG_OPT_ENTRY(PERS_TEMPORAL_CONSISTENCY_DELTA_US),
        MAKE_LONG_OPT_ENTRY(PERS_CLIENT_SERVER_EPSILON_US),
        // [LOGGER]
