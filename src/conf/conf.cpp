...
struct option Conf::long_options[] = {
        ...
        // [PERS]
        MAKE_LONG_OPT_ENTRY(CONF_PERS_STORAGE_TYPE),
        MAKE_LONG_OPT_ENTRY(CONF_PERS_RESET),
        MAKE_LONG_OPT_ENTRY(CONF_PERS_FS_FILE_PATH),
        MAKE_LONG_OPT_ENTRY(CONF_PERS_FS_MAX_LOG_ENTRY),
        MAKE_LONG_OPT_ENTRY(CONF_PERS_FS_MAX_DATA_SIZE),
        MAKE_LONG_OPT_ENTRY(CONF_PERS_SPDK_TRTYPE),
        MAKE_LONG_OPT_ENTRY(CONF_PERS_SPDK_ADRFAM),
        MAKE_LONG_OPT_ENTRY(CONF_PERS_SPDK_TRADDR),
        MAKE_LONG_OPT_ENTRY(CONF_PERS_SPDK_TRSVCID),
        MAKE_LONG_OPT_ENTRY(CONF_PERS_SPDK_SUBNQN),
        {0, 0, 0, 0}};
