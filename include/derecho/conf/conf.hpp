...
#define CONF_DERECHO_MAX_P2P_WINDOW_SIZE "DERECHO/max_p2p_window_size"
#define CONF_DERECHO_MAX_RPC_REPLY_PAYLOAD_SIZE "DERECHO/max_rpc_reply_payload_size"
...
#define CONF_LOGGER_DEFAULT_LOG_LEVEL "LOGGER/default_log_level"
    ...
    std::map<const std::string, std::string> config = {
	    ...
	    {CONF_DERECHO_MAX_P2P_WINDOW_SIZE, "16"},
	    {CONF_DERECHO_MAX_RPC_REPLY_PAYLOAD_SIZE, "10240"},
