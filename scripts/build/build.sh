...
OPT_PATH=${HOME}/opt
export C_INCLUDE_PATH=${OPT_PATH}/include
export CPLUS_INCLUDE_PATH=${OPT_PATH}/include
export LIBRARY_PATH=${OPT_PATH}/lib
export CMAKE_SYSTEM_LIBRARY_PATH=${OPT_PATH}/lib
