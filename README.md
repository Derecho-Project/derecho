...
* Open Fabric Interface (OFI) library: [`libfabric`](https://github.com/ofiwg/libfabric). To avoid compatibility issue, please use commit `fcf0f2ec3c7109e06e09d3650564df8d2dfa12b6` on `master` branch.
* Logging library: [`spdlog`](https://github.com/gabime/spdlog). To avoid compatibility issue, please use commit `10e809cf644d55e5bd7d66d02e2604e2ddd7fb48` on `master` branch.
* Matthew's C++ utilities
  - [`mutils`](https://github.com/mpmilano/mutils)
  - [`mutils-containers`](https://github.com/mpmilano/mutils-containers)
  - [`mutils-tasks`](https://github.com/mpmilano/mutils-tasks)
